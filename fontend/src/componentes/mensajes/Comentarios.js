...
export default function Comentarios({ dataBanda, isOpen, closeModal }) {
  const initialForm = {
    nombre: "",
    mensaje: "",
    mail: "",
  ...
  let api = helpHttp();
  const endpoint = "mensajes/create";
          ...
          <div className="cuerpo-container">
            ...
            <form onSubmit={handleSubmit} className="form-field-container">
              ...
              <textarea
                ...
                id="mensaje"
                name="mensaje"
                placeholder={`datos que quieras agregar sobre ${dataBanda.nombre}`}
                onChange={handleChange}
                value={form.mensaje}
                rows="4"
              ></textarea>
